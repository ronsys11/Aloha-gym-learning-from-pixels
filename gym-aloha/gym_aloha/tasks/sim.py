...
class BimanualViperXTask(base.Task):
    ...
    def get_observation(self, physics):
        ...
        obs["images"] = {}
        obs["images"]["top"] = physics.render(height=140, width=240, camera_id="top")
        obs["images"]["angle"] = physics.render(height=140, width=240, camera_id="angle")
        obs["images"]["vis"] = physics.render(height=140, width=240, camera_id="front_close")
...
class TransferCubeTask(BimanualViperXTask):
    ...
    def get_reward(self, physics):
        ...
        if touch_left_gripper:  # attempted transfer
            reward = 3
        if touch_left_gripper and not touch_right_gripper and not touch_table:  # successful transfer
            reward = 4
        return reward
